...
export const api = {
  ...
  meGusto: (p_por_probar_tienda_id, p_precio_final, p_donde_comprar, p_donde_comprar_tienda_id) => rpc('me_gusto', { p_por_probar_tienda_id, p_precio_final, p_donde_comprar, p_donde_comprar_tienda_id }),
